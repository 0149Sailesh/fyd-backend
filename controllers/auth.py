...
def register_user(user: RegistrationDetails):
    ...
    try:
        ...
        user_instance.password = auth_handler.get_password_hash(user.password)
        ...
        raise HTTPException(status_code=400, detail="phonenumber already exist")
...
def login_user(creds: LoginDetails):
    try:
        ...
        raise HTTPException(status_code=401, detail="Invalid phonenumber and password")
